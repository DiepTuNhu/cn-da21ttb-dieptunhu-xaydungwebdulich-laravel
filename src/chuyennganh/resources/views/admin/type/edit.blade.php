      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form id="quickForm" action="{{route('types.update',['id'=>$type->id])}}" method = "post">
                @csrf
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <select name="status" class="form-control" id="status">
                      <option value="0" {{ $type->status == 0 ? 'selected' : '' }}>Visible</option>
                      <option value="1" {{ $type->status == 1 ? 'selected' : '' }}>Hidden</option>
                  </select>
                </div>
              </div>
              <!-- /.card-body -->
